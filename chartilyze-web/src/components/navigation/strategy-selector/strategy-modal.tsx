...
// Update the interface to match the correct StrategyComponent type
interface StrategyComponent {
  id: string
  type: 'rule' | 'condition' | 'action' | 'indicator_check' | 'pattern_match' // Updated valid types
  name: string
  description: string
                  ...
                  <div key={component.id} className="bg-gray-800 rounded-lg border border-gray-700">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-sm text-gray-400">{component.tags?.length || 0} tags</span>
                        <button
                          onClick={(e) => {
                            e.stopPropagation()
